...
void Gui::drawHealth(SDL_Renderer* renderer, int health) {
	...
	render.renderSheetEx(renderer, healthSheet, 0, 0, 0, 16, (int)(health * 2.56), 32, 128, 16, 0);
}
...
void Gui::drawProgression(SDL_Renderer* renderer, int level, int progression) {
	...
	render.renderSheetEx(renderer, progressionSheet, (screenWidth / 2) - 128, screenHeight - 32, 0, 16, (int)(progression * 2.56), 32, 128, 16, 0);
